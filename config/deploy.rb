...
set :application, "portfolio" # this will be used to create the folder structure (see line)
...
after 'deploy:update_code', 'deploy:sync_config', 'deploy:restart', 'deploy:build_missing_paperclip_styles'
